...
def get_by_primary_type(primary_type):
    ...
    infrastructure = shotgun_api.db.infrastructure.find({'properties.type.primary': primary_type}, projection = {'_id': False, 'properties.optional': False, 'properties.original': False}) 
...
def get_infrastructure(primary_type, secondary_type):
    ...
    if primary_type == 'null':
        infrastructure = shotgun_api.db.infrastructure.find({'properties.type.secondary': secondary_type}, projection = {'_id': False, 'properties.optional': False, 'properties.original': False})
    else:
        infrastructure = shotgun_api.db.infrastructure.find({"$and": [{'properties.type.primary': primary_type},{'properties.type.secondary': secondary_type}]}, projection = {'_id': False, 'properties.optional': False, 'properties.original': False})    
